    ...
    <div class="card-body">
      {#if currentStep === "welcome"}
        ...
        <div class="text-center py-8">
          ...
          <h2 class="text-xl font-semibold text-base-content mb-6">
            Ready to submit your project for voting?
          </h2>
          <button
      ...
      {:else if currentStep === "joinEvent"}
        ...
        <div class="mt-6 text-center">
          ...
          >
            Click here if you're in an event (and already used this flow) and
      ...
      {:else if currentStep === "complete"}
        ...
        <div class="text-center py-8">
          <div class="mb-8">
            ...
            <p class="text-base-content/70 mb-6">
              Your project has been submitted and it's under review!
            </p>
          </div>
