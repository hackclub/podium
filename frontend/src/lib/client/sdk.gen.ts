...
export class DefaultService {
     ...
     * Trigger Error
     */
    public static triggerErrorSentryDebugGet<ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) {
        return (options?.client ?? client).get<TriggerErrorSentryDebugGetResponse, TriggerErrorSentryDebugGetError, ThrowOnError>({
            ...options,
            url: '/sentry-debug'
        });
    }
