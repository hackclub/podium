...
export class EventsService {
     ...
     */
    public static changeVotableEventsChangeVotablePut<ThrowOnError extends boolean = false>(options: OptionsLegacyParser<ChangeVotableEventsChangeVotablePutData, ThrowOnError>) {
        return (options?.client ?? client).put<ChangeVotableEventsChangeVotablePutResponse, ChangeVotableEventsChangeVotablePostError, ThrowOnError>({
            ...options,
            url: '/events/{event_id}/change-votable'
        });
    }
