...
export class SuperadminService {
     ...
     */
    public static listAllEventsSuperadminEventsGet<ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) {
